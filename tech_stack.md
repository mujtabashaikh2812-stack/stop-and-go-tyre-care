...
- **Deployment & Target**: Mobile Web App / PWA / Android Webview & Tablet Desktop
...
- **Printing**: Native CSS `@media print` thermal receipt layout (80mm width standard)
- **WhatsApp Direct**: Native `https://wa.me/` deep-linking with auto-formatted UTF-8 invoice messages
